import 'dart:ui';
import 'package:gpay/repositories/preferences_repository.dart';
...
class PreferencesRepositoryImpl implements PreferencesRepository {
  ...
  Future<void> saveLocale(Locale locale) async {
    ...
    await prefs.setString(_localeScriptCodeKey, locale.scriptCode.toString());
    await prefs.setString(_localeCountryCodeKey, locale.countryCode.toString());
