...
class CashAppRequestForm extends StatefulWidget {
  const CashAppRequestForm({Key? key}) : super(key: key);

  @override
  _CashAppRequestFormState createState() => _CashAppRequestFormState();
}

class _CashAppRequestFormState extends State<CashAppRequestForm> {
  //Variables
  ...
  _executeTransaction(BuildContext context) async {
    ...
    await RechargeServices.getLoadCashApp(_passwordController.text,
                          ...
                          Container(
                            child: TextFormField(
                              decoration: InputDecoration(
                                  label: Text(
                                    '${S.of(context).reference} CashApp *',
                                    style: const TextStyle(
