...
import 'package:gpay/models/recharge/load_pay_safe_response.dart';
...
class _PaySafeCashFormState extends State<PaySafeCashForm>
  ...
  _executeTransaction(BuildContext context) async {
    ...
    await RechargeServices.getLoadPaySafeRequest(_amountController.text)
        .then((response) => {
