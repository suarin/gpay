...
class _VisaTransactionsForm extends State<VisaTransactionsForm> with WidgetsBindingObserver{
  ...
  _getTransactions() async{
    ...
    await PurchaseService.getVisaTransactions(selectedCard!.cardNo.toString(), _endDateController.text).then((list) => {
      _visaTransactionsResponse = VisaTransactionsResponse.fromJson(list),
      setState(() {
                        ...
                        children: [
                          ...
                          transactionsLoaded ? SizedBox(
                            child: ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount: _visaTransactionsResponse!.transacciones!.length,
                                itemBuilder: (context , index){
                                  VisaTransaction visaTransaction = _visaTransactionsResponse!.transacciones![index];
                                  return Container(
                                    child: Center(
                                      child: Column(
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              SizedBox(
                                                child: Text(
                                                  'USD ${visaTransaction.debit.toString()}',
                                                  style: const TextStyle(
                                                    fontFamily: 'VarelaRoundRegular',
                                                    color: Colors.red
                                                  ),
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              SizedBox(
                                                child: Text(
                                                  'USD ${visaTransaction.credit.toString()}',
                                                  style: const TextStyle(
                                                    fontFamily: 'VarelaRoundRegular',
                                                    color: Colors.green
                                                  ),
