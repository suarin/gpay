...
class _MobilePaymentWebViewState extends State<MobilePaymentWebView> {
  ...
  _getMobilePaymentData() async {
    await TransferServices.getMobilePayment().then((res) => {
      ...
      setState(() {
        url = 'https://bgipay.me/spa/xcmo/securew/trans_movilpay.asp?CHolderID=${mobilePayResponse!.cHolderId}&Token=${mobilePayResponse!.token}';
        isProcessing = false;
      })
    });
  }
