...
import 'package:gpay/models/transfer/pagomobil_pay_response.dart';
...
class PagoMobilPayTransferForm extends StatefulWidget {
  const PagoMobilPayTransferForm({Key? key}) : super(key: key);

  @override
  _PagoMobilPayTransferFormState createState() => _PagoMobilPayTransferFormState();
}

class _PagoMobilPayTransferFormState extends State<PagoMobilPayTransferForm>
  ...
  PagoMobilPayResponse pagoMobilPayResponse = PagoMobilPayResponse();
  ...
  _showSuccessResponse(
      BuildContext context, PagoMobilPayResponse pagoMobilPayResponse) {
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            SizedBox(
                              child: Text(pagoMobilPayResponse.authNo.toString()),
                              width: 150,
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            SizedBox(
                              child: Text(pagoMobilPayResponse.response.toString()),
                              width: 150,
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            SizedBox(
                              child:
                                  Text(pagoMobilPayResponse.totalDebit.toString()),
                              width: 150,
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            SizedBox(
                              child:
                                  Text(pagoMobilPayResponse.bankCodeID.toString()),
                              width: 150,
                            ),
                          ],
                        ),
  ...
  _checkResponse(BuildContext context, dynamic json) async {
    if (json['ErrorCode'] == 0) {
      PagoMobilPayResponse pagoMobilPayResponse = PagoMobilPayResponse.fromJson(json);
      _showSuccessResponse(context, pagoMobilPayResponse);
    } else {
      String errorMessage =
  ...
  _executeTransaction(BuildContext context) async {
    ...
    await TransferServices.getIntMovilPay(
            _passwordController.text,
            _amountController.text,
            _recipientController.text,
